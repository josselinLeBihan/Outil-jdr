...
export const CompetenceCard = ({ competence, onClick, isUltime }) => {
  const baseClasses = "w-full p-4 rounded-lg shadow hover:shadow-md transition-all border-2 text-left";
  ...
  return (
    <button onClick={() => onClick(competence)} className={classes}>
      <h3 className="text-lg font-semibold text-gray-800 mb-1">{competence.nom}</h3>
