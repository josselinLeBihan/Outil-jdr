...
const CaracteristiquesSection = ({ character, editMode, onUpdate }) => {
      ...
      <div className="grid grid-cols-3 gap-6">
        ...
        <div>
          ...
          <DotRating
            ...
            maxValue={5}
            onChange={(v) => onUpdate('caracteristiques.physique.constitution', v)}
            disabled={!editMode}
          />
          <DotRating
            label="Adresse"
        ...
        <div>
          ...
          <DotRating
            ...
            maxValue={5}
            onChange={(v) => onUpdate('caracteristiques.social.manipulation', v)}
            disabled={!editMode}
          />
          <DotRating
            label="Sang froid"
        ...
        <div>
          ...
          <DotRating
            ...
            maxValue={5}
            onChange={(v) => onUpdate('caracteristiques.mental.intelligence', v)}
            disabled={!editMode}
          />
          <DotRating
            label="Astuce"
